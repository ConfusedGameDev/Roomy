...
namespace PlayFab.Multiplayer.Interop
{
    public static unsafe partial class Methods
    {
        ...
        [DllImport(ThunkDllName, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern int PFMultiplayerCreateAndClaimServerLobby([NativeTypeName("PFMultiplayerHandle")] PFMultiplayer* handle, [NativeTypeName("const PFEntityKey *")] PFEntityKey* server, [NativeTypeName("const PFLobbyCreateConfiguration *")] PFLobbyCreateConfiguration* createConfiguration, void* asyncContext, [NativeTypeName("PFLobbyHandle *")] PFLobby** lobby);

        [DllImport(ThunkDllName, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern int PFMultiplayerClaimServerLobby([NativeTypeName("PFMultiplayerHandle")] PFMultiplayer* handle, [NativeTypeName("const PFEntityKey *")] PFEntityKey* server, [NativeTypeName("const char *")] sbyte* lobbyId, void* asyncContext, [NativeTypeName("PFLobbyHandle *")] PFLobby** lobby);

        [DllImport(ThunkDllName, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern int PFMultiplayerJoinLobbyAsServer([NativeTypeName("PFMultiplayerHandle")] PFMultiplayer* handle, [NativeTypeName("const PFEntityKey *")] PFEntityKey* server, [NativeTypeName("const char *")] sbyte* connectionString, [NativeTypeName("const PFLobbyServerJoinConfiguration *")] PFLobbyServerJoinConfiguration* configuration, void* asyncContext, [NativeTypeName("PFLobbyHandle *")] PFLobby** lobby);
        ...
        [DllImport(ThunkDllName, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern int PFLobbyServerPostUpdateAsServer([NativeTypeName("PFLobbyHandle")] PFLobby* lobby, [NativeTypeName("const PFLobbyServerDataUpdate *")] PFLobbyServerDataUpdate* lobbyServerUpdate, void* asyncContext);
